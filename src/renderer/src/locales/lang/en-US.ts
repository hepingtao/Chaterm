...
export default {
  ...
  user: {
    ...
    sshKeepaliveInterval: 'SSH keepalive interval (seconds)',
    sshKeepaliveIntervalDescribe: 'Interval for SSH keepalive probes, default 10 seconds',
    sshIdleTimeout: 'SSH idle timeout (seconds)',
  ...
  personal: {
    ...
    showIpAndName: 'Show IP and Name',
  ...
  files: {
    ...
    favoriteDir: 'Favorite Directories',
    noFavorites: 'No favorite directories',
    addedToFavorites: 'Added to favorites',
    removedFromFavorites: 'Removed from favorites',
    newFolder: 'New Folder',
    newFolderPrompt: 'Enter folder name',
    createDirSuccess: 'Folder created successfully',
    createDirFailed: 'Failed to create folder',
    copyDirSuccess: 'Directory copied successfully',
    copyDirFailed: 'Failed to copy directory',
