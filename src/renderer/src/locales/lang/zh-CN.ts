...
export default {
  ...
  user: {
    ...
    sshKeepaliveInterval: 'SSH心跳间隔（秒）',
    sshKeepaliveIntervalDescribe: 'SSH连接保活探测的发送间隔，默认10秒',
    sshIdleTimeout: 'SSH空闲超时（秒）',
  ...
  files: {
    ...
    createDirFailed: '文件夹创建失败',
    copyDirSuccess: '目录复制成功',
    copyDirFailed: '目录复制失败',
    uploadSkipped: '已跳过上传',
